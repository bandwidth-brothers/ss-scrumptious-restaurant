	...
	stages{
		...
		stage('Publish'){
			steps{
				...
				sh "curl -X POST http://ec2-54-193-221-59.us-west-1.compute.amazonaws.com:8080/job/scrumptious-restaurant-backend-deploy/build?token=restaurant-backend-tok"
			}
		}
	}
}
